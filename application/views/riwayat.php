				...
				<div class="bg-light align-self-stretch box p-4 text-center">
					<div class="container table-responsive">
						<div class="col-md-12 heading-section ftco-animate">
							<h2 class="mb-4"><span>Tabel</span> Pembayaran</h2>
							<p style="text-align: left !important;"><span style="color: rgb(231, 78, 78);">“Total biaya pembayaran sudah termasuk biaya pendaftaran dan biaya bimbel pada bulan pertama” <br> “Tata cara pembayaran : <br>
									...
									4. Tunggu konfirmasi dari admin yang bersangkutan, apabila sudah di informasi oleh admin anda bisa mendownload bukti pembayaran(invoice) sebagai syarat untuk daftar ulang ke bimbel smart bimbel indramayu.”</span></p>
						</div>
							...
							<tbody>
								...
								foreach ($riwayat as $riw) : ?>
									<tr>
										...
										<td><a href="#" data-toggle="modal" data-target="#myModalfoto<?= $riw['id_pendaftaran'] ?>"><img src="<?= base_url('assets/upload/bukti_pembayaran/') . $riw['bukti_pembayaran'] ?>" alt="" height="60px" width="70px"></a></td>
										<td>
											<?php if ($riw['status_pembayaran'] == '1') : ?>
												<a href=" <?= base_url('siswa/invoice/' . $riw['id_pendaftaran']) ?>" target="_blank" class="text-success">Donwload Bukti Pembayaran</a></td>
									<?php elseif ($riw['status_pembayaran'] == '2') : ?>
										<a href="#" class="text-warning">Menunggu Konfirmasi Admin</a></td>
									<?php else : ?>
										<a href="#" class="text-primary">Upload bukti pembayaran</a>
									<?php endif; ?>
									<td>
										<?php if ($riw['status_pembayaran'] == '1') : ?>
