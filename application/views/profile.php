 	...
 	<div class="container">
 		<div class="row no-gutters slider-text align-items-center justify-content-center">
 			<div class="col-md-9 ftco-animate text-center">
 				...
 				<p class="breadcrumbs"><span class="mr-2"><a href="<?= base_url(); ?>home/landing">Beranda <i class="ion-ios-arrow-forward"></i></a></span> <span>Pendaftaran <i class="ion-ios-arrow-forward"></i></span></p>
 			</div>
 		</div>
 	</div>
 </section>
 						...
 						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 							<div class="form-group" style="margin-bottom: 1.8rem;">
 								<div class="form-line">
 									...
 									<center><img src="<?= base_url(); ?>assets/upload/foto/<?= isset($profile['foto']) ? $profile['foto'] : "default.png" ?>" alt="" title="Masukan Foto Anda" style="min-height:220px;max-height:220px;min-width:220px;max-width:130px;"></center>
 							...
 							<div class="form-group" style="margin-bottom: 1.8rem;">
 								<div class="form-line">
 									<select name="pendidikan" id="asd" class="form-control">
										...
										<option value="" <?= ($profile['pendidikan'] == '') ? 'selected' : "" ?>>-- Pilih Pendidikan --</option>


										 <option value="SD" <?= ($profile['pendidikan'] == 'SD') ? 'selected' : "" ?>>-- SD --</option>
										 <option value="SMP" <?= ($profile['pendidikan'] == 'SMP') ? 'selected' : "" ?>>-- SMP --</option>
										 <option value="SMA" <?= ($profile['pendidikan'] == 'SMA') ? 'selected' : "" ?>>-- SMA --</option>
